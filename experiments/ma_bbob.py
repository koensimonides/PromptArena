...
for mpi in range(start_index, len(prompts_lists)):
    ...
    constructor = ClassicPrompt(mutation_prompts=prompts, task_prompt=task_message) if parents == 1 else CrossoverPrompt(crossover_prompts=prompts, parent_count=parents, task_prompt=task_message)
